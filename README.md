...
| Gateway Service      | Gateway for backend services | [Spring Cloud Gateway](https://cloud.spring.io/spring-cloud-gateway/reference/html/)                                                                                                                                                 | 8700 |
...
| local config server  | Centralized Configurations   | spring cloud config                                                                                                                                                                                                                  | 8888 |
